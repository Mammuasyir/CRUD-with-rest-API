package com.rival.my_packet.adapter.search
...
class SearchAdapter(var search: List<ResultItem?>?) :    RecyclerView.Adapter<SearchAdapter.MyViewHolder>() {
    ...
    override fun getItemCount()= search?.size ?: 0
}